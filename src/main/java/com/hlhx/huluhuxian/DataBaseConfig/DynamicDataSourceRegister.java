...
public class DynamicDataSourceRegister
    ...
    private void initCustomDataSources(Environment env) {
        ...
        for (String dsPrefix : dsPrefixs.split(",")) {// 多个数据源
            ...
            RelaxedPropertyResolver propertyResolver1 = new RelaxedPropertyResolver(env, "custom.spring.datasource."+dsPrefix+".");
            Map<String, Object> dsMap = new HashMap<>();
            dsMap.put("type", propertyResolver1.getProperty("type"));
            dsMap.put("driver-class-name", propertyResolver1.getProperty("driver-class-name"));
